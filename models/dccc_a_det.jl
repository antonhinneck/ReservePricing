function build_dccc_a_det(generators, buses, lines, farms, αm_det::Array{T, 1} where T <: Real, αp_det::Array{T, 1} where T <: Real, p_det::Array{T, 1} where T <: Real; output_level = 0)
